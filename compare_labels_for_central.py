...
for participant in participants:
    ...
    for condition in conditions:
        ...
        for hemi in hemispheres:
            ...
            data = [participant[0],participant[1],condition,hemi,'central',peak_vertex_abs,peak_vertex_surf,peak_time,peak_vertex_surf_fs,stc,time]
    ...
    if participant[1] == '118801':
        ...
        ylims = [0,50]
    for hemi in hemispheres:
        df_to_plot = df_participant.loc[(df_participant['hemisphere']== hemi)]
        ...
        title = 'central' + '_' + hemi + '_activations'
        ...
        report.add_figure(fig=fig1, title=title, section=section, tags=[condition,hemi,diagnosis])
        ...
        report.add_figure(fig=fig2, title=title, section=section, tags=[condition,hemi,diagnosis])
...
df.to_pickle('/local_mount/space/hypatia/2/users/Jasmine/Misophonia/Poster_images/Jun2024/roi_time_series_abs/central_sulcus_misoVsNovels.pkl')
...
for hemi in hemispheres:
    ...
    df_to_plot = df_miso.loc[df_miso['hemisphere']== hemi]
    ...
    fig_to_save = sub_fig.get_figure()
    savename = '/local_mount/space/hypatia/2/users/Jasmine/Misophonia/Poster_images/Jun2024/roi_time_series_abs/Grand_average_activations_' + 'Central Sulcus' + '_' + hemi + '_.tiff'
    sub_fig.savefig(savename,dpi=300)
    ...
    report.add_figure(fig=fig, title='Grand-averaged activations', section=section, tags=['grand_average',hemi])


report.save("/local_mount/space/hypatia/2/users/Jasmine/Misophonia/Poster_images/Jun2024/central_sulcus/central_sulcus_labels_miso_vs_novel.html", overwrite=True)
