...
for participant in participants:
    ...
    for condition in conditions:
        ...
        for hemi in hemispheres:
            ...
            std_drawn_label = mne.extract_label_time_course(
                    stc_standard, drawn_label, src, mode="mean_flip", verbose="error"
                )
            data_drawn_abs = flip_peaks(data_drawn_label[0]) - flip_peaks(std_drawn_label[0])
...
df.to_pickle('/local_mount/space/hypatia/2/users/Jasmine/Misophonia/Poster_images/Jun2024/roi_time_series_abs/ROI_time_series_peaksVsLabels_minusBeeps.pkl')
...
for hemi in hemispheres:
    for label in labels:
        ...
        report.add_figure(fig=fig, title='Grand-averaged activations', section=section, tags=['grand_average',hemi,label], replace=True)


report.save("/local_mount/space/hypatia/2/users/Jasmine/Misophonia/Poster_images/Jun2024/roi_time_series_abs/miso_peak_vertex_and_labels_minusBeeps.html", overwrite=True)